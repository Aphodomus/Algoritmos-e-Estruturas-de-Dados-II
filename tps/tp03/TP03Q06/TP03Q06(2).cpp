...
void new_filaCircularFlexivel(){
    ...
    filaCircularFlexivel->primeiro = (Celula*)malloc(sizeof(Celula));
    /* PQ DIABOS EU NAO ACESSO ESSE PRIMEIRO ? */
    filaCircularFlexivel->primeiro->prox = NULL;
...
int main() {
    ...
    new_filaCircularFlexivel(/* filaCircularFlexivel */);
